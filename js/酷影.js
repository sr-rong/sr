    var rule = {
        ...
        class_url: '1&2&4&3&5',
        play_parse: true,
        lazy:'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("http://jx.realdou.cn/home/api?type=ys&uid=1308131&key=aefgjklstzABDFQU78&url="+input);input={jx:1,url:JSON.parse(purl).url,parse:1}}',
        limit: 6,
