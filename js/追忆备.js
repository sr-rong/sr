    var rule = {
        ...
        class_url: '1&7&8&3',
        play_parse: true,
        lazy:'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("|NZWNwN0ZXZE02WTRreHpXY2ZmNjJwY0RjWGlZN2ZmQWF8aHR0cDovLzIyMi4yMTEuNzMuMTU3OjExMjIvYXBwdG8vdjE="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
        limit: 6,
